...
using ProSDKSamples.GP;
using ProSDKSamples.ProjectItemProjectContainer;
using ProSDKSamples.SubscribeEvents;
using Module = ArcGIS.Desktop.Framework.Contracts.Module;
using ArcGIS.Desktop.Internal.Mapping;
using System.Collections.Generic;

namespace ProSDKSamples
{
    internal class ProSDKSampleModule : Module
    {
        private static ProSDKSampleModule _this = null;
        private GPHelper _gpHelper = null;

        /// <summary>
        /// Retrieve the singleton instance to this module here
        /// </summary>
        public static ProSDKSampleModule Current
        {
            get
            {
                return _this ?? (_this = (ProSDKSampleModule)FrameworkApplication.FindModule("ProSDKSamples_Module1_id"));
            }
        }

        public static MapView ActiveMapView {
            get {
                return MappingModule.ActiveMapView;
            }
        }

        public static MapViewInternal ActiveMapViewInternal
        {
          get
          {
            ...
            return activePane.GetActiveView() as MapViewInternal;
          }
        }
