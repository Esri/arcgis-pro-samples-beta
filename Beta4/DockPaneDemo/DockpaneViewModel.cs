...
namespace UCSamples.DockPaneDemo
{
    class DockpaneViewModel : DockPane, INotifyPropertyChanged
    {
        ...
        protected async Task Initialize()
        {
            ...
            FrameworkApplication.EventAggregator.GetEvent<ArcGISProjectOpenedEvents>().Subscribe(OnProjectOpened);
            FrameworkApplication.EventAggregator.GetEvent<ArcGISProjectCreatedEvents>().Subscribe(OnProjectOpened);
            FrameworkApplication.EventAggregator.GetEvent<ArcGISProjectClosedEvents>().Subscribe(OnProjectClosed);
