...
namespace UCSamples.EditingCutFeatures
{
    internal class CutFeaturesTool : SketchTool
    {
        ...
        protected override Task OnReactivateImpl() {
            return this.UpdateEditSketchSymbol();
        }

        protected override Task UpdateEditSketchSymbol() {
            return base.UpdateEditSketchSymbolImpl(this.CurrentTemplate);
        }
